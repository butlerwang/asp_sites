...
Article_Pics=Article_Pics&"<div class='ImageBlockBG'><div class='ImageBlock'><a href='/images/up_images/"&PicsContent(i)&"'  rel='sexylightbox[group1]' title='"&rs("title")&"'><img src='/images/up_images/"&PicsContent(i)&"' alt='"&rs("title")&"'/></a><p>"&Left(rs("title"),13)&"</p></div></div> "
next
else
Article_Pics="<p>暂无图片。</p>"
end if
...
article_next=article_next&"<p><A class='imgBorder'  href='"&rs_url&"' target='_blank' title='"&rs("title")&"'>"&left(rs("title"),10)&"</A></p>"
article_next=article_next&" </DIV>"
 
rs.movenext
next
else
article_next=article_next&"暂无相关信息."
end if
rs.close
set rs=nothing
