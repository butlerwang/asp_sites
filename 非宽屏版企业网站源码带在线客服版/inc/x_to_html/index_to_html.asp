...
WebAboutContent=left(ClearHtml(rs("content")),78)
...
WebNewNewsList=WebNewNewsList&"<div class='DivLi'><span>"&year(rsp("time"))&"/"&month(rsp("time"))&"/"&day(rsp("time"))&"</span> <a href='"&rs_url&"' target='_blank' title='"&rsp("title")&"'>"&left(rsp("title"),28)&"</a></div>"
rsp.movenext
loop
end if 
rsp.close
...
rs_url=""
rs_url=ArticleContent_FolderName&"/"&rsp("file_path")
WebArticleList=WebArticleList&"<div class='DivLi'>· <a href='"&rs_url&"' target='_blank' title='"&rsp("title")&"'>"&left(rsp("title"),19)&"</a></div>"
rsp.movenext
loop
end if 
rsp.close
...
WebCaseList=WebCaseList&"<a href='"&rs_url&"' target='_blank'><img src='/images/Up_Images/"&rsp("image")&"' width='204' height='155' alt='"&rsp("title")&"'></a><p><a href='"&rs_url&"' target='_blank' title='"&rsp("title")&"'>"&left(rsp("title"),15)&"</a></p>"
else
...
rs_url=""
rs_url=CasesContent_FolderName&"/"&rsp("file_path")
WebCaseList=WebCaseList&"<li>· <a href='"&rs_url&"' target='_blank' title='"&rsp("title")&"'>"&left(rsp("title"),15)&"</a></li>"
rsp.movenext
loop
end if 
rsp.close
...
Block_LeftClassList=Block_LeftClassList&"<li><A href='"&WebProductFolder&"/"&rsl("Folder")&"'>"&rsl("name")&" <span>("&ClassCount&")</span></A> "
...
do while not rs.eof 
Block_LeftClassList=Block_LeftClassList&"<li><a href='"&WebProductFolder&"/"&rsl("Folder")&"/"&rs("folder")&"/' target='_blank' >"&rs("name")&"</a></li> "
rs.movenext
loop
Block_LeftClassList=Block_LeftClassList&"</ul>"
end if
...
Block03_LeftItem=Block03_LeftItem&"<DIV class='box'><A class='imgBorder' href='"&rs_url&"' target='_blank' title='"&rsp("title")&"'><IMG src='/images/up_images/"&rsp("image")&"' alt='"&rsp("title")&"' ></A> <p><A href='"&rs_url&"' target='_blank' title='"&rsp("title")&"'>"&left(rsp("title"),16)&"</A> </p></DIV>"
