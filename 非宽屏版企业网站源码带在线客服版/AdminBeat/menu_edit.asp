...
document.form1.url.value=document.form1.Category_list.value;
	...
	<tr>
	  <td height=23 colspan="2" class='forumRow'><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="30" valign="top" class="TipWords"><p>1、导航只是'链接'，这个链接可以是网络上的任何网址或者本网站的任何栏目。</p>
          <p>2、你要将'栏目'链接到'导航'，请确保此栏目是已经存在的栏目，否则导航是无法打开的。添加栏目请点击此处<a href='category_add.asp'>添加新栏目</a>
          <p>3、<span style='color:#F00;font-weight:bold;'>不要妄图将一个不存在的栏目添加到导航，别怪我没提醒你！！！</span></p>
          </td>
        </tr>
        <tr>
          <td height="10">&nbsp;</td>
