...
<title><%=gdb("select web_name from web_settings ")%>-海纳企业网站管理系统</title>
...
<div class="CopyR">2013 &copy; <a href="http://www.hitux.com" target="_blank">海纳网络工作室</a> www.hitux.com 版权所有 All rights reserved  </div>
