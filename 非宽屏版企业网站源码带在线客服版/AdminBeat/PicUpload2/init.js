...
AjaxProcesser.prototype.getProcess=function(){
	_this=this;
	Ajax({
		url:"PicUpload2/getProcess.asp?processid=" + this.processID,
		method:"get",
		dataType:"json",
		asc:true,
