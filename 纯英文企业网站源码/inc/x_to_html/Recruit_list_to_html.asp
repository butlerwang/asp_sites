...
list_block=list_block&"<td colspan='2' align='left' class='Rtitle'><strong>&nbsp;"&rs("title")&"</strong>&nbsp;&nbsp;&nbsp;&nbsp;<span>["&year(rs("time"))&"-"&month(rs("time"))&"-"&day(rs("time"))&"]</span></td></tr>"
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>Place：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("address")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>Salary：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("person")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>Count：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("tel")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>Sex：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("email")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>Age：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("qq")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>Condition：</td>"
list_block=list_block&"<td width='86%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("description")&"</strong></td></tr>"
list_block=list_block&"<tr><td align='center' bgcolor='#F9F9F9'>Description：</td>"
...
list_page=list_page&"Total: "&rscount&"条&nbsp;&nbsp;Current Page: <span class='FontRed'>" & j & "</span>/" & totalpage &""
...
<%'循环列表替换内容
replace_code=replace(replace_code,"$list_block$","No Data.")   
