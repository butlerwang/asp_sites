...
[关闭]
  ...
  <tr>
    <td class='forumRowhighlight'  height="25" ><span style="font-weight: bold">姓名</span></td>
  ...
  <tr>
   ...
   <tr>
    <td class='forumRowhighlight'  height="25"><span style="font-weight: bold">电话</span></td>
    <td class='forumRowhighlight' >&nbsp;<%=rs("qq")%></td>
  </tr>    <tr>
    <td class='forumRowhighlight'  height="25"><span style="font-weight: bold">IP</span></td>
    <td class='forumRowhighlight' >&nbsp;<%=rs("IP")%></td>
  </tr> 
