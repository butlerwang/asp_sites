...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="30" valign="top" class="TipWords">
              <p>1、建议不要创建过多备份数据库，以节省系统空间。检查过期无用的备份数据库将其删除。</p></td>
          </tr>
          <tr>
            <td height="10" ></td>
          </tr>
...
class_style="forumRowHighLight"
          ...
          <tr >
           ...
           <td class='<%=class_style%>' ><div align="center"><%=rs("dataname")%></div></td>
            ...
            <div align="center"><a href="Data_Restore.asp?Dataname=<%=rs("dataname")%>">还原</a> | <a href="javascript:if(ask('警告：删除后将不可恢复，可能造成意想不到后果？')) location.href='Data_del.asp?id=<%=rs("id")%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>';">删除</a>            </div></td>
          </tr></form>
		  		  <%
		  rs.movenext
		  next
