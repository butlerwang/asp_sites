	...
	<tr><td height="400" valign="top"  class='forumRow'><br>
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <p>2、获取更多主题请点击 <a href="http://www.Junww.com/" target="_blank">获取主题</a>。</p>
            </td>
          </tr>
          <tr>
            <td height="10" ></td>
...
<div class='inner'>
<div class='img'><a href='#' target='_blank'><img src="/images/up_images/<%=rs("image")%>" width="200" height="225" border="0" alt="<%=rs("name")%>"></a>
