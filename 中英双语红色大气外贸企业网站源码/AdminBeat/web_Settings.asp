...
<td class='forumRow'><input type='text' id='web_url' name='web_url' value="<%=rs("web_url")%>" size='40'> 
  &nbsp;请以http://开头，<span style="color: #FF0000" >后面不要带 / </span>，如：<a href="http://www.Junww.com/" target="_blank">http://www.Junww.com</a></td>
	</tr>
	  <tr>
	...
	<tr>
	  ...
	  <td class='forumRowHighLight'><input type='text' id='v44' name='web_tel'  value="<%=rs("web_tel")%>" size='40'></td>
	</tr>
	<tr>
	  <td class='forumRow' height=23>首页视频地址</td>
	  <td class='forumRow'><input type='text' id='v44' name='web_person'  value="<%=rs("web_person")%>" size='40'> 请输入绝对地址，如“/vcastr2/test.flv”或“http://www.xxx.com/test.flv”</td>
	</tr>
	<tr>
