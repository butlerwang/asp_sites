...
list_block=list_block&"<div class='albumblock'><div class='inner'><a href='"&rs_url&"' target='_blank'  title='"&left(rs("title"),39)&"'><img src='/images/up_images/"&rs("image")&"' /></a><div class='albumtitle ColorLink'><a href='"&rs_url&"' target='_blank'  title='"&left(rs("title"),39)&"'>"&left(rs("title"),18)&"</a></div></div></div>"
