...
sql="select [web_theme],web_url from web_settings "
...
%> <script type="text/javascript" src="PicUpload/init.js"></script>
	...
	<script charset="utf-8" src="Keditor/editor.js"></script> <!-- 三级联动菜单 开始 -->
...
%>
			...
			if rs("pid")<>"" then				
set rsc3=server.createobject("adodb.recordset")
sqlClass3="select id,pid,ppid,name from category where ppid=3 and ClassType=1 and pid="&cint(rs("pid"))&" order by id" 
rsc3.open sqlClass3,cn,1,1
