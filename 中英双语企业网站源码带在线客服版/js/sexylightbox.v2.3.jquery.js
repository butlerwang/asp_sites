  ...
  SexyLightbox = {
    ...
    overlay: {
      ...
      inject: function() {
        ...
        // No tengo tiempo para agregar la detecci髇 del OS que deber千
        // haber estado integrada en jQuery, pero que el est鹧ido de su creador no puso
        // Me cago en John Resig
        {
          ...
          // Diossss por diosss, pongan funciones 鸥iles en jQuery,
    ...
    /*
    Function: replaceBox
    @description  Cambiar de tama駉 y posicionar el lightbox en el centro de la pantalla
    */
