...
%>
<li><a href="/images/up_images/<%=PicsContent(i)%>" target="_blank"><img src="/images/up_images/<%=PicsContent(i)%>" width="60" height="60"></a><p><a href='Pics_Del.asp?order=<%=i%>&id=<%=rs("id")%>&Name=<%=PicsContent(i)%>'>删除</a></p></li>
