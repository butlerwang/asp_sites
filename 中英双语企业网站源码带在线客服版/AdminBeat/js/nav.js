...
t=outlookbar.addtitle('中文一网站设置','中文一系统设置',1)
outlookbar.additem('网站信息设置',t,'web_settings.asp')
outlookbar.additem('网站客服设置',t,'chat_settings.asp')

t=outlookbar.addtitle('中文一导航管理','中文一系统设置',2)
...
t=outlookbar.addtitle('中文一广告管理','中文一系统设置',3)
...
t=outlookbar.addtitle('中文一友情链接','中文一系统设置',4)
outlookbar.additem('添加链接',t,'link_add.asp')
outlookbar.additem('链接列表',t,'link_list.asp')


t=outlookbar.addtitle('中文一栏目管理','栏目管理',1)
outlookbar.additem('添加一级栏目',t,'category_add.asp?ppid=1')
outlookbar.additem('栏目列表',t,'category_list.asp')

t=outlookbar.addtitle('中文一留言管理','栏目管理',2)
outlookbar.additem('留言列表',t,'message_list.asp')

t=outlookbar.addtitle('英文一栏目管理','栏目管理',3)
outlookbar.additem('添加一级栏目',t,'en_category_add.asp?ppid=1')
outlookbar.additem('栏目列表',t,'en_category_list.asp')

t=outlookbar.addtitle('英文一留言管理','栏目管理',4)
outlookbar.additem('留言列表',t,'en_message_list.asp')

t=outlookbar.addtitle('中文一文章管理','中文一内容管理',1)
...
t=outlookbar.addtitle('中文一产品管理','中文一内容管理',2)
...
t=outlookbar.addtitle('中文一案例管理','中文一内容管理',3)
outlookbar.additem('添加案例',t,'case_add.asp')
outlookbar.additem('案例列表',t,'case_list.asp')

t=outlookbar.addtitle('中文一招聘管理','中文一内容管理',4)
...
t=outlookbar.addtitle('英文一网站设置','英文一系统设置',1)
outlookbar.additem('网站信息设置',t,'en_web_settings.asp')

t=outlookbar.addtitle('英文一导航管理','英文一系统设置',2)
outlookbar.additem('添加一级导航',t,'en_menu_type_add.asp')
outlookbar.additem('一级导航列表',t,'en_menu_type_list.asp')
outlookbar.additem('添加二级导航',t,'en_menu_add.asp')
outlookbar.additem('二级导航列表',t,'en_menu_list.asp')

t=outlookbar.addtitle('英文一广告管理','英文一系统设置',3)
outlookbar.additem('广告位置管理',t,'en_ads_position_list.asp')
outlookbar.additem('添加广告',t,'en_ads_add.asp')
outlookbar.additem('广告列表',t,'en_ads_list.asp')

t=outlookbar.addtitle('英文一友情链接','英文一系统设置',4)
outlookbar.additem('添加链接',t,'en_link_add.asp')
outlookbar.additem('链接列表',t,'en_link_list.asp')


t=outlookbar.addtitle('英文一文章管理','英文一内容管理',1)
outlookbar.additem('添加文章',t,'en_article_add.asp')
outlookbar.additem('文章列表',t,'en_article_list.asp')
outlookbar.additem('文章关键词',t,'en_keywords_list.asp')
outlookbar.additem('文章来源',t,'en_author_list.asp')

t=outlookbar.addtitle('英文一产品管理','英文一内容管理',2)
outlookbar.additem('添加产品',t,'en_product_add.asp')
outlookbar.additem('产品列表',t,'en_product_list.asp')
outlookbar.additem('订单管理',t,'en_order_list.asp')

t=outlookbar.addtitle('英文一案例管理','英文一内容管理',3)
outlookbar.additem('添加案例',t,'en_case_add.asp')
outlookbar.additem('案例列表',t,'en_case_list.asp')

t=outlookbar.addtitle('英文一招聘管理','英文一内容管理',4)
outlookbar.additem('添加招聘职位',t,'en_info_add.asp')
outlookbar.additem('招聘职位列表',t,'en_info_list.asp')
...
outlookbar.additem('生成中文首页',t,'html_index.asp')
