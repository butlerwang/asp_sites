...
sql="select id,order from en_web_menu_type where id="&id1&""
rs1.open(sql),cn,1,3
rs1("order")=order1
rs1.update
rs1.close
...
%>
	...
	<tr><td height="400" valign="top"  class='forumRow'><br>
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="30" valign="top" class="TipWords"><p>1、“一级导航”的意思：导航就是一排链接。不同类型的链接即一级导航。</p>
            </td>
          </tr>
          <tr>
            <td height="10" ></td>
	    ...
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="25" class='forumRowHighLight'>&nbsp;| <a href="en_menu_type_add.asp">添加新的一级导航</a></td>
          </tr>
          <tr>
            <td height="30"></td>
          </tr>
	    ...
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
          <tr>
            ...
            <td width="27%" height="30" class="TitleHighlight"><div align="center" style="font-weight: bold;color:#ffffff">导航名称</div></td>
            <td width="11%" class="TitleHighlight"><div align="center" style="font-weight: bold;color:#ffffff">备注</div></td>
            <td width="9%" class="TitleHighlight"><div align="center" style="font-weight: bold;color:#ffffff">二级导航个数</div></td>
...
<% '文章列表模块
strFileName="en_menu_type_list.asp" 
pageno=25
set rs = server.CreateObject("adodb.recordset")
s_sql="select * from en_web_menu_type order by  [order]"
...
class_style="forumRowHighLight"
          ...
          <tr >
           ...
           <td class='<%=class_style%>' ><div align="center"><%=rs("name")%></div></td>
            ...
            <div align="center"><a href="en_menu_type_edit.asp?id=<%=rs("id")%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>">修改</a> | <a href="javascript:if(ask('警告：删除后将不可恢复，可能造成意想不到后果？')) location.href='en_menu_type_del.asp?id=<%=rs("id")%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>';">删除</a>            </div></td>
          </tr></form>
		  		  <%
		  rs.movenext
		  next
