...
set rs=nothing
%>
<% '判断主题文件夹是否存在，否则创建，需要在三个地方创建Templates,css,query
...
Set Fso=Server.CreateObject("Scripting.FileSystemObject") 
If Fso.FolderExists(Server.MapPath("/images/"&l_url))=false Then
NewFolderDir="/images/"&l_url
call CreateFolderB(NewFolderDir)
end if
%>
<%
...
return true;}
	...
	<td class='forumRow'><input name='name' type='text' id='name' size='40' maxlength="40">
	  ...
	  <td class='forumRowHighLight'><input type="text" name='memo'   size='40' id="memo" ></td>
	</tr>
