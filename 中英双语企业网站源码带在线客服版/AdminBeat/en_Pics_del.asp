...
sql="select Pics,[id] from [en_Article] where id="&a_id&" and Pics like '%"&FileName&"%'"
rs.open(sql),cn,1,3
if not rs.eof then
...
response.Write "<script language='javascript'>alert('删除成功！');location.href='en_Pics_list.asp?id="&a_id&"';</script>"
