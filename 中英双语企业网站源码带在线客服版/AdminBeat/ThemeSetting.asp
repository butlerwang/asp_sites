...
set rs1=server.createobject("adodb.recordset")
sql="select web_theme,web_ThemeID from en_web_settings "
rs1.open(sql),cn,1,3
rs1("web_theme")=ThemeFolder
rs1("web_ThemeID")=ThemeID
rs1.update
...
'response.Write "<script language='javascript'>alert('该主题启用成功，请点击‘前台首页’查看首页效果！查看全部页面效果需要先生成其它页面！');location.href='ThemeSetting.asp';</script>"
end if
%>
	...
	<tr><td height="400" valign="top"  class='forumRow'><br>
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <p>1、启用了某个主题后，会自动生成【中文】所有页面，生成过程可能耗费一定时间，请耐心等待。【英文】所有页面请到'静态管理'-'生成英文'处'生成所有页面'即可。</p>
            <p>2、如果发现有页面没有更新为新启用主题，请到'静态管理'-'生成所有页面'即可！。</p>
            </td>
          </tr>
          <tr>
            <td height="10" ></td>
