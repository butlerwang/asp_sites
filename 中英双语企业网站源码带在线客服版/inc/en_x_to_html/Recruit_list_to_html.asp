...
<%
 '文章列表读取替换
sql="select * from [en_web_info] where "&ClassSQL&"='"&ClassID&"' and view_yes=1  order by [time] desc"
set rs1=server.createObject("ADODB.Recordset")
rs1.open sql,cn,1,1
%><%
if not rs1.eof then
...
list_block=list_block&"<tr><td width='14%' align='center' bgcolor='#F9F9F9'>Number: </td>"
...
list_block=list_block&"<tr><td align='center' bgcolor='#F9F9F9'>Job Description: </td>"
