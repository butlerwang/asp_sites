...
list_block=list_block&"<td width='85%' class='fw_t'>·<a href='"&rs_url&"' target='_blank'>"&left(rs("title"),35)&"</a></td>"
list_block=list_block&"<td width='15%' class='fw_s'>["&year(rs("time"))&"-"&month(rs("time"))&"-"&day(rs("time"))&"]</td>"
list_block=list_block&"</tr>"
%>
<%
rs.movenext
