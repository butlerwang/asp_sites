...
document.writeln('<option value=\'20132758361159\'>旺旺客服 </option><option value=\'20139767592670\'>QQ客服 </option>        </select>')
document.writeln('        <input name=\"key\" type=\"text\" class=\"textbox\"  value=\"关键字\" onfocus=\"this.select();\"/>')
document.writeln('        <input name=\"ChannelID\" value=\"114\" type=\"hidden\" />')
