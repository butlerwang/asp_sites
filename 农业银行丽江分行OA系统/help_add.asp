...
sql = "select * from helptype order by id asc"
...
<form method="POST" name="myform" action="help_save.asp?action=add">
...
%>
        ...
        <tr>
          <td width="15%" align="right" height="30"><b>UBB标签：</b></td>
