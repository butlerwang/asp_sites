...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td class="heading" bgcolor="#4e5960" height=20>　<font color="#FFFFFF"><b>系统帮助</font></b></td>
...
%>
		  ...
		  <a href="?typeid=<%=my_rs("id")%>" class="t1">
          <%=my_rs("type")%></a><br> 
...
%>                                                         
    <tr>                
      ...
      <td bgcolor="#F6F6F6">  <a href="edit_help.asp?id=<%=rs("id")%>&typeid=<%=rs("type")%>" onClick="return js_openpage(this.href);"><%=rs("title")%>                                                                                      </A>                                      
                　</td>                                   
      <td bgcolor="#F6F6F6">                  
