...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
    <tr bgcolor="#4E5960"> 
      <td class="heading" height="20"><font color="#FFFFFF"><b>个人名片修改</b></font></td>
    </tr>
  </table>
  <table width="100%" border="1" cellspacing="0" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="#000000">
    <tr> 
      ...
      <td width="85%" bgcolor="#efefef"> 
        <input type="text" name="cname" maxlength="20" size="20" value="<%=rs("cname")%>">
  ...
  <tr> 
      ...
      <td width="85%" bgcolor="#efefef"> 
        <input type="text" name="company" size="60" maxlength="100" value="<%=rs("company")%>">
    </td>
  </tr>
  <tr> 
      <td width="15%" bgcolor="#bfbfbf"> 
      ...
      <td width="85%" bgcolor="#efefef"> 
        <input type="text" name="comaddress" size="60" maxlength="200" value="<%=rs("comaddress")%>">
    </td>
  </tr>
  ...
  <tr> 
      ...
      <td width="85%" bgcolor="#efefef"> 
        <input type="text" name="postcode" size="10" maxlength="6" value="<%=rs("postcode")%>">
    </td>
  </tr>
  <tr> 
      <td width="15%" bgcolor="#bfbfbf"> 
      ...
      <td width="85%" bgcolor="#efefef"> 
        <input type="text" name="duty" size="20" maxlength="50" value="<%=rs("duty")%>">
    </td>
  </tr>  
  <tr> 
      <td width="15%" bgcolor="#bfbfbf"> 
      ...
      <td width="85%" bgcolor="#efefef"> 
        <input type="text" name="phone" size="20" maxlength="50" value="<%=rs("phone")%>">
    </td>
  </tr>
  <tr> 
      <td width="15%" bgcolor="#bfbfbf"> 
      ...
      <td width="85%" bgcolor="#efefef"> 
        <input type="text" name="fax" size="20" maxlength="50" value="<%=rs("fax")%>">
    </td>
  </tr>
  <tr> 
      <td width="15%" bgcolor="#bfbfbf"> 
      ...
      <td width="85%" bgcolor="#efefef"> 
        <input type="text" name="handset" size="20" maxlength="50" value="<%=rs("handset")%>">
    </td>
  </tr>
  <tr> 
      <td width="15%" bgcolor="#bfbfbf"> 
      ...
      <td width="85%" bgcolor="#efefef"> 
        <input type="text" name="email" size="40" maxlength="100" value="<%=rs("email")%>">
    </td>
  </tr>
  ...
  <tr> 
      ...
      <td width="85%" bgcolor="#efefef"> 
        <textarea name="remark" cols="60" rows="4"><%=rs("remark")%></textarea>
    </td>
  </tr>
</table>
<div align="center"><br>
        
        <a href="Javascript:DelChk(<%=id%>);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','images/delete_on.gif',1)"><img name="Image1" border="0" src="images/delete_off.gif" width="60" height="19" hspace="5"></a>&nbsp; 
...
function DelChk(cardid)
    {
        if(confirm("确认删除吗?"))
            document.location="delcard.asp?id="+cardid ;
    }
function ChkCard()
{
