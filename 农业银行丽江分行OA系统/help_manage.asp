...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td class="heading" bgcolor="#4e5960" height=20>　<font color="#FFFFFF"><b>帮助文件管理</font></b></td>
    ...
    <td width="110" valign="top"> <br>
      <table width="100%" border="0" cellspacing="0" cellpadding="2" align="center" >
        <tr > 
		  ...
		  <a href="javascript:js_openpage('help_add.asp')" class="t1">添加文件</a><br> 
              　<img src="images/open.gif" align="absmiddle"> 
			  <a href="" class="t1">栏目管理
               </font></a><br> 
              　<img src="images/open.gif" align="absmiddle"> 
			  <a href="help_edit.asp" class="t1">删除修改</font></a><br> 
          </td> 
     </tr> 
      </table> 
    </td> 
...
%>     
<FORM METHOD=POST ACTION="help_add_save.asp">
<tr>                                                    
