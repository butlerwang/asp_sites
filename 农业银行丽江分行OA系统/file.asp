...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td class="heading" bgcolor="#4e5960" height=20>　<font color="#FFFFFF"><b>软件下载</font></b></td>
...
%>  <table border=1 cellspacing="0" cellpadding="0" width="100%" bordercolorlight=#000000 bordercolordark=#ffffff>                                                       
    <tr style="padding:1pt;background-color:cccccc">                
      ...
      <td><a href="<%=rs("url")%>"><%=rs("name")%></A> <%if rs("best")=true then response.write " <FONT COLOR=red>*</FONT>" end if%><%if session("Urule")="a" then%>[<A HREF="#" onclick="window.open('esoft.asp?id=<%=rs("id")%>','','width=400 height=250')"><FONT COLOR="#000000">修</FONT></A>] [<A HREF="delsoft.asp?id=<%=rs("id")%>" onclick="return delsoft()"><FONT COLOR="#000000">删</FONT></A>] <%end if%>                                     
                　</td>                                   
