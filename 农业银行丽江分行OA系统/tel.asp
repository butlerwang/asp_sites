...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td class="heading" bgcolor="#4e5960" colspan="2" >　<font color="#FFFFFF"><b>常用电话</b></font></td>
  </tr>
  <tr> 
...
PageSize = 17
dim rs,strSQL,news
strSQL ="SELECT * FROM tel where 电话名称 like '%"&keyword&"%' ORDER BY id DESC"
...
%> <table border="0" cellspacing="0" cellpadding="0" width="100%">
          ...
          <tr bgcolor="#bfbfbf">                  
            <td width="50%"><b>单位名称</b></td>                 
            <td width="30%"><b>电话号码</b></td>                 
...
%>                 
          <tr>                  
            <td width="50%" bgcolor="#efefef"><%=rs("电话名称")%></td>                 
            <td width="30%" bgcolor="#efefef"><%=rs("电话号码")%></td>                 
              <% if session("Urule")="a" then			
			%> 
			<td width="10%" bgcolor="#efefef"><A HREF="delphone.asp?id=<%=rs("id")%>" onclick="return cform();">删除</A></td>                 
            <%end if%>            
          </tr>                 
          <%rs.movenext 
count=count+1
          ...
          <tr>                 
            ...
            <td bgcolor="#BFBFBF" width="16%">&nbsp;                  
              <select size="1" name="seler">                 
                <option value="phonename">单位名称</option>
              </select>
            </td>
			...
			%>  
			<A HREF="#" onClick="MM_openBrWindow('addphone.asp','','width=400,height=150')"><img src="images/add_off.gif" align="middle" border=0></a>
			<%
			end if
			%>
            </td>
