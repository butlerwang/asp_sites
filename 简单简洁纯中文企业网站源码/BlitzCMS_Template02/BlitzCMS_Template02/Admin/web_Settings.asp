...
<td class='forumRow'><input type='text' id='web_url' name='web_url' value="<%=rs("web_url")%>" size='40'> 
  &nbsp;请以http://开头，<span style="color: #FF0000" >后面不要带 / </span>，如：<a href="http://shop101214018.taobao.com/" target="_blank">http://PayNet.taobao.com</a></td>
	</tr>
	  <tr>
	...
	<tr>
	  <td class='forumRow' height=23>首页联系方式代码</td>
	  <td class='forumRow'> <textarea name='web_TopHTML' cols="100" rows="10"  id="web_TopHTML" ><%=rs("web_TopHTML")%></textarea></td>
	</tr>	
	<tr>
