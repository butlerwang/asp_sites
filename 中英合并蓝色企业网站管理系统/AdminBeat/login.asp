...
<title><%=gdb("select web_name from web_settings ")%>-慧谷动力企业网站管理系统</title>
...
<div class="CopyR">2012 &copy; <a href="http://www.huiguer.com" target="_blank">huiguerCMS</a> www.huiguer.com 版权所有 All rights reserved  </div>
