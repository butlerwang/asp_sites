...
<div id="nav">
    ...
    <li id="man_nav_3" onclick="list_sub_nav(id,'栏目管理')"  class="bg_image">栏目管理</li>
      <%If logr() Then %>    
    <li id="man_nav_2" onclick="list_sub_nav(id,'中文一系统设置')"  class="bg_image">中文一系统设置</li>
<%End If %>
    <li id="man_nav_4"  onclick="list_sub_nav(id,'中文一内容管理')"  class="bg_image">中文一内容管理</li>
      <%If logr() Then %>    
    <li id="man_nav_7" onclick="list_sub_nav(id,'英文一系统设置')"  class="bg_image">英文一系统设置</li>
<%End If %>    
    <li id="man_nav_9"  onclick="list_sub_nav(id,'英文一内容管理')"  class="bg_image">英文一内容管理</li>
      <%If logr() Then %>        
