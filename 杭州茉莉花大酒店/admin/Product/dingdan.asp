...
<table width="98%"  border="0" cellpadding="0" cellspacing="1" align="center" bgcolor="#99CCFF">
  ...
  <tr align="left" bgcolor="#E8F1FF">
    ...
    <td width="16%"  height="22" align="center" valign="middle" nowrap bgcolor="#FFFFFF" class="sbe_button"><strong>&nbsp;产品名称&nbsp;</strong></td>
    <td width="20%"  align="center" valign="middle" nowrap bgcolor="#FFFFFF" class="sbe_button"><strong>&nbsp;产品类别&nbsp;</strong></td>
    <td width="9%"  height="22" align="center" valign="middle" nowrap bgcolor="#FFFFFF" class="sbe_button"><strong>&nbsp;客户名称&nbsp;</strong></td>
    <td width="18%"  align="center" valign="middle" nowrap bgcolor="#FFFFFF" class="sbe_button"><strong>&nbsp;联系电话</strong></td>
    <td width="12%"  align="center" valign="middle" nowrap bgcolor="#FFFFFF" class="sbe_button"><strong>&nbsp;E-mail</strong>&nbsp;</td>
...
'	    Response.Write "<tr align=left bgcolor=#E8F1FF><td height=20 colspan=12 valign=middle>"&ly_time&"还没有<font color='#FF0000'>已回复</font>的订单信息。</td></tr>"
  ...
  <form action="dingdan.asp?method=ok" name="form1" method="post">
    ...
    <tr align="left" bgcolor="#E8F1FF">
      ...
      <td height="22" align="center" valign="middle" bgcolor="#FFFFFF"><%=gotTopic(rs("productname"),24)%></td>
      <td align="center" valign="middle" nowrap bgcolor="#FFFFFF">&nbsp;<%=rs("category")%>&nbsp;</td> 
      <td height="22" align="center" valign="middle" bgcolor="#FFFFFF"><a href="dd_show.asp?id=<%=rs("ID")%>"><%=gotTopic(rs("username"),20)%></a></td>
      <td align="center" valign="middle" nowrap bgcolor="#FFFFFF"><%=gotTopic(rs("usertel"),30)%></td>
      <td align="center" valign="middle" nowrap bgcolor="#FFFFFF"><%=(rs("useremail"))%></td>
      <td align="center" valign="middle" bgcolor="#FFFFFF"><%=rs("timing")%></td>
