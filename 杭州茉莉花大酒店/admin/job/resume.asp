...
<%Dim Act
  ...
  Sub Ability()
     ...
     Sql="Update Sbe_Resume set Ability=1 Where ID in("&ID&")"	 
	 Conn.execute sql
	 Response.Redirect(request.ServerVariables("HTTP_REFERER"))
	 Response.End()
  End Sub
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <form name="formsearch" method="get" action="resume.asp"> 
      <td width="79%"> <strong>【<font color="#FF0000"><img src="../images/i_search.gif" width="14" height="14">信息搜索</font>】 
        ...
        <input type="button" name="ref" value="不能自动刷新点击" onClick="location.href='resume.asp'"  class="sbe_button" title="默认为查找所有信息">
      </td>
    </form>
  </tr>
  <tr> 
