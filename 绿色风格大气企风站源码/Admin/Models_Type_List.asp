	    ...
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="30" valign="top" class="TipWords"><p>1、“模板分类”的意思：网站的每一个页面都是由模板生成的，首页有首页的模板，文章页有文章页面的模板，留言有留言页面的模板，这就构成了模板的分类。</p>
                ...
                <p>3、“目标文件夹”的意思：每个模板都生成一个页面，这些页面放在哪呢，就是目标文件夹了，目标文件夹均是建立在根目录下的。 举例，www.huiguer.com/product/是产品页面，product即是目标文件夹。</p>
                ...
                <p>7、系统默认的9个模板分类都是网站必须的，非专业编程人员，删除请慎重，切记啊。</p>
            </td>
          </tr>
          <tr>
            <td height="10" ></td>
