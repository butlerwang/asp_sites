...
%>
	...
	<tr>
	  <th width="100%" height=25 class='tableHeaderText'>产品评论列表</th>
	...
	<tr><td height="400" valign="top"  class='forumRow'><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="30" valign="top" class="TipWords"><p>1、评论列表显示所有产品的评论，可对评论进行回复。</p>
            <p>2、批量删除评论后建议生成产品内容页才能看到更新。</p></td>
      </tr>
      <tr>
        <td height="10" ></td>
      </tr>
 ...
 <form name="form2" method="post" action="PComment_Del.asp?action=AllDel&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>">
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
          <tr>
            ...
            <td width="54%" height="30" class="TitleHighlight"><div align="center" style="font-weight: bold;color:#ffffff">评论内容</div></td>
            ...
            <td width="9%" class="TitleHighlight"><div align="center" style="font-weight: bold;color:#ffffff">问题操作</div></td>
          </tr>
<% '产品列表模块
...
%>
          ...
          <tr >
            ...
            <td class='forumRowHighLight'><div align="center"><a href="Pcomment_view_yes.asp?id=<%=rs("id")%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>"><%if rs("view_yes")=1 then%>已审核<%else%><span style="color: #FF0000">未审核</span><% end if%></a></div></td>
            <td class='forumRowHighLight' ><div align="center"><%=rs("time")%></div></td>
            <td class='forumRowHighLight' >
            <div align="center"><a href="javascript:if(ask('警告：删除后将不可恢复，可能造成意想不到后果？')) location.href='Pcomment_del.asp?id=<%=rs("id")%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>';">删除</a></div>				</td>
          </tr>
		            <tr >
