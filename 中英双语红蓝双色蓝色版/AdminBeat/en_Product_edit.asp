...
<tr>
	  ...
	  <tr>
	    ...
	    <td class='forumRowHighLight'><input name='a_wine' type='text' id='a_wine' size='30'  value="<%=rs("wine")%>"></td>
      </tr>
	  <tr>
	    <td class='forumRow' height=23>优惠价</td>
	    <td class='forumRow'><input name='a_net' type='text' id='a_net' size='30'  value="<%=rs("net")%>"></td>
      </tr>      
