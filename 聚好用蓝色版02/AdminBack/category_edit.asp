...
response.write "当前为一级栏目"
	...
	<tr>
	<td class='forumRowHighLight' height=23>栏目文件夹名称（必填）</td>
    <td class='forumRowHighLight'><input type='text' id='c_folder' name='c_folder' value="<%=rs2("folder")%>" size='40'  >
      <span style="color: #FF0000">请用英文字母命名，保持为空将自动使用栏目名称的拼音命名。（勿与系统文件夹名重复！）</span> </td>
	</tr>
	  <tr>
	    ...
	    <td width="85%" class='forumRow'><table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
           ...
           <td width="78%"  class='forumRow'><iframe width="500" name="ad" frameborder=0 height=30 scrolling=no src=upload.asp?juhaoyongUploadFileName=<%=juhaoyongGetUploadFileName(rs2("image"))%>&juhaoyongUpLoadPath=<%=juhaoyongGetweb_theme()%>></iframe><font color="#FF0000">（注：上传的图片名称必须是英文或数字）</font></td>
         </tr>
       </table></td>
      </tr>
