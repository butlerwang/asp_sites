...
return true;}
	...
	<td width="85%" class='forumRowHighLight'><input name='Enname' type='text' id='Enname' size='70' maxlength="30">
	  &nbsp;</td>
	</tr>
	  <tr>
	    <td class='forumRow' height=23>导航链接（必填）</td>
	    <td class='forumRow'><input name='url' type='text' id='url' size='70'> 格式如：/About/<font color="#FF0000">（要同“内容管理>>栏目内容管理”中的栏目层级和“栏目文件夹名称”保持一致）</font></td>
      </tr>
	  <tr>
