	...
	<tr><td height="400" valign="top"  class='forumRow'><br>
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <p>2、获取更多主题请点击 <a href="http://www.juhaoyong.net/" target="_blank">获取主题</a>。</p>
            </td>
          </tr>
          <tr>
            <td height="10" ></td>
...
%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Theme_edit.asp?id=<%=rs("id")%>&amp;page=<%=page%>&amp;act=<%=act%>&amp;keywords=<%=keywords%>">Edit</a> - <a href="javascript:if(ask('警告：删除后将不可恢复，确定要删除吗？')) location.href='Theme_del.asp?id=<%=rs("id")%>&amp;page=<%=page%>&amp;act=<%=act%>&amp;keywords=<%=keywords%>';">Del</a></p></div>
</div>
</div>
<%
		  rs.movenext
