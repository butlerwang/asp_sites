...
TD.TitleHighlight2 {
	PADDING-RIGHT: 3px; PADDING-LEFT: 3px; BACKGROUND:#4F94CD; PADDING-BOTTOM: 3px; PADDING-TOP: 3px;color:#fFFFFFF;
}
TD.TitleHighlight3 {
	PADDING-RIGHT: 3px; PADDING-LEFT: 3px; BACKGROUND:#A9CAE8; PADDING-BOTTOM: 3px; PADDING-TOP: 3px
}
.tableBorder {
	BORDER: #d4e0ea 1px solid; WIDTH: 98%;BACKGROUND-COLOR: #ffffff;
}
...
'------获取同级目录下的最新一篇文章id(添加文章前获取到id，以便于重新生成该篇文章)jhyfunction------
...
function juhaoyongGetUploadFileName(fileName)
    ...
    if pos>0 then 
		...
		juhaoyongGetUploadFileName=left(juhaoyongGetUploadFileName,instr(juhaoyongGetUploadFileName,".")-1)
    else
        juhaoyongGetUploadFileName=left(fileName,instr(fileName,".")-1)
    end if
end function
