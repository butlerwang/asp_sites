...
%>
	...
	<tr><th width="100%" height=25 class='tableHeaderText'>一级导航</th></tr>
...
<p>1、<font color="#FF0000">特别提醒：增加、修改、删除导航后，请重新生成所有静态。</font></p>
<p>2、不要设置过多导航，可能会导致页面变形。</p>
            </td>
          </tr>
          <tr>
            <td height="10" ></td>
	    ...
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="25" class='forumRowHighLight'>&nbsp;| <a href="menu_type_add.asp">添加新的一级导航</a></td>
          </tr>
          <tr>
            <td height="30"></td>
          </tr>
...
class_style="forumRowHighLight"
          ...
          <tr >
           ...
           <td class='<%=class_style%>' ><div align="center"><%=rs("name")%>&nbsp;&nbsp;<%=rs("Enname")%></div></td>
            ...
            <div align="center"><a href="menu_type_edit.asp?id=<%=rs("id")%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>">修改</a> | <a href="javascript:if(ask('警告：删除后将不可恢复，确定要删除吗？')) location.href='menu_type_del.asp?id=<%=rs("id")%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>';">删除</a>            </div></td>
          </tr></form>
		  		  <%
		  rs.movenext
		  next
