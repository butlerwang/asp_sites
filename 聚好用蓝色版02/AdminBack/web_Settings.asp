...
<td class='forumRow'><input type='text' id='web_url' name='web_url' value="<%=rs("web_url")%>" size='40'> 
  &nbsp;请以http://开头，<span style="color: #FF0000" >后面不要带 / </span>，如：<a href="http://www.juhaoyong.net/" target="_blank">http://www.juhaoyong.net</a></td>
	</tr>
	  <tr>
	    ...
	    <td width="85%" class='forumRowHighLight'><table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
           ...
           <td width="78%"  class='forumRow'><iframe width="500" name="ad" frameborder=0 height=30 scrolling=no src=upload.asp?juhaoyongUploadFileName=<%=juhaoyongGetUploadFileName(rs("web_image"))%>&juhaoyongUpLoadPath=<%=juhaoyongGetweb_theme()%>></iframe><font color="#FF0000">（注：上传的图片名称必须是英文或数字）</font></td>
         </tr>
       </table></td>
      </tr>
