	  ...
	  <tr>
	    ...
	    <td width="85%" class='forumRow'><table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
           ...
           <td width="78%"  class='forumRow'><iframe width="500" name="ad" frameborder=0 height=30 scrolling=no src=upload.asp?juhaoyongUpLoadPath=<%=juhaoyongGetweb_theme()%>></iframe><font color="#FF0000">（注：上传的图片名称必须是英文或数字）</font></td>
         </tr>
       </table></td>
      </tr>
