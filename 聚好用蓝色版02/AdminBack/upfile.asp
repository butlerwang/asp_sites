...
juhaoyongUploadFileName=upload.form("juhaoyongUploadFileName")
juhaoyongUpLoadPath=upload.form("juhaoyongUpLoadPath")

if juhaoyongUpLoadPath<>"" then
formPath="/css/"&juhaoyongUpLoadPath
else
...
response.Write "<script language='javascript'>alert('文件格式不对，请重新上传！');location.href='upload.asp';</script>"
 ...
 if juhaoyongUploadFileName<>"" then
	filename=formPath&juhaoyongUploadFileName&fileExt
	filename1=juhaoyongUploadFileName&fileExt
 else
	randomize
