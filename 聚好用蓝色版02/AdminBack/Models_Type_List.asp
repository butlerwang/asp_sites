...
%>
	...
	<tr><td height="400" valign="top"  class='forumRow'><br>
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="30" valign="top" class="TipWords"><p>1、“模板分类”的意思：网站的每一个页面都是由模板生成的，首页有首页的模板，文章页有文章页面的模板，留言有留言页面的模板，这就构成了模板的分类。</p>
                <p>2、网站的所有模板都是放在根目录下的Templates文件夹内的，此文件夹内的每个一个文件夹即是一个网站主题存放模板的地方。</p>
                <p>3、网站根目录下会有许多系统文件夹，您命名的目标文件夹最好不要与这些文件夹重复，否则会产生很严重后果。</p>
                <p>4、为避免频繁的文件操作，已经命名的“模板文件名”是不能修改的，命名前请慎重，如果实在需要修改，只能打开数据库进行手动修改了。</p>
            </td>
          </tr>
          <tr>
            <td height="10" ></td>
...
class_style="forumRowHighLight"
          ...
          <tr >
           ...
           <td class='<%=class_style%>' ><div align="center"><%=rs("name")%></div></td>
            ...
            <div align="center"><a href="Models_Type_edit.asp?id=<%=rs("id")%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>">修改</a> | <a href="javascript:if(ask('警告：删除后将不可恢复，确定要删除吗？')) location.href='Models_type_del.asp?id=<%=rs("id")%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>';">删除</a>            </div></td>
          </tr></form>
		  		  <%
		  rs.movenext
		  next
