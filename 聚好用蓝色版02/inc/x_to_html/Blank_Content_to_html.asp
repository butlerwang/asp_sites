...
rsl.open(sql),cn,1,1
if not rsl.eof then
	Block_LeftClassList=Block_LeftClassList&"<div class='Sbox'>"
	Block_LeftClassList=Block_LeftClassList&"<div class='topic'>"&ClassName1&"&nbsp;&nbsp;&nbsp;"&ClassFolder1&"</div>"
	Block_LeftClassList=Block_LeftClassList&"<div class='blank'>"
	...
	rsl.movenext
	next
	Block_LeftClassList=Block_LeftClassList&"</ul></div>"
	Block_LeftClassList=Block_LeftClassList&"</div>"
	Block_LeftClassList=Block_LeftClassList&"<div class='HeightTab clearfix'></div>"
else
