...
list_block=list_block&"<div class='albumblock'><div class='inner'><a href='"&rs_url&"' target='_blank'  title='"&trim(rs("title"))&"'><img src='/images/up_images/"&rs("image")&"' /><div class='albumtitle'>"&left(rs("title"),16)&"</div></a></div></div>"
