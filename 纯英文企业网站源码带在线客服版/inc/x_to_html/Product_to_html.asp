...
MorePro_List=MorePro_List&"<div class='albumblock'><div class='inner'><a href='"&rs_url&"' target='_blank' title='"&rsp("title")&"'><img src='/images/up_images/"&rsp("image")&"'  ></a><div class='albumtitle'><a href='"&rs_url&"' target='_blank' title='"&rsp("title")&"'>"&left(rsp("title"),24)&"</a></div></div></div>"
rsp.movenext
loop
else
MorePro_List=MorePro_List&"No Product."
end if 
rsp.close
set rsp=nothing
%>
...
Article_Pics="<li>No More Pics.</li>"
end if
