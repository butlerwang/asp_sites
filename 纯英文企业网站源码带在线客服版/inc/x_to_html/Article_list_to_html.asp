...
list_block=list_block&"<li class='ColorLink'><span>"&year(rs("time"))&"-"&month(rs("time"))&"-"&day(rs("time"))&"</span><a href='"&rs_url&"' target='_blank'>"&left(rs("title"),70)&"</a>"
list_block=list_block&"<p >"&left(ClearHtml(rs("content")),200)&" ...</p>"
