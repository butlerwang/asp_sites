...
for ii=0 to dc
Article_Downloads=Article_Downloads&"<div class='download ColorLink'><b>File Download：</b>"
Article_Downloads=Article_Downloads&"<a href='/data/"&DownloadFiles(ii)&"' target='_blank'>"&DownloadFiles(ii)&"</a> <span class='ListDate'>(Click for download)</span></div> "
next
end if
...
rs.open(sql),cn,1,1
article_next=article_next&"<ul><li>Last："
if not rs.eof and not rs.bof then
rs_url=""
if rs("url")<>"" then
rs_url=rs("url")
...
article_next=article_next&"No News."
end if
