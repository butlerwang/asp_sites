...
s_sql="select id,title,cid,pid,ppid,file_path,image,index_push,slide_yes,special_yes,view_yes,headline,hit,ip,time from article where [title] like '%"&keywords&"%' and ArticleType=1 order by time desc"
elseif pid="" and ppid="" then
search_sql="and cid='"&cid&"'"
s_sql="select id,title,cid,pid,ppid,file_path,image,index_push,slide_yes,special_yes,view_yes,headline,hit,ip,time from article where [title] like '%"&keywords&"%'"&search_sql&" and ArticleType=1  order by time desc"
elseif ppid="" then
...
s_sql="select id,title,cid,pid,ppid,file_path,image,index_push,slide_yes,special_yes,view_yes,headline,hit,ip,time from article  where ArticleType=1  order by time desc"
