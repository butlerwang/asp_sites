...
document.form1.url.value=document.form1.Category_list.value;
	...
	<td width="85%" class='forumRowHighLight'><input name='name' type='text' id='name' size='40' maxlength="30"> <select  id="Category_list" onChange="show()">
...
%>
</select> 栏目不存在？点此<a href='category_add.asp'>添加新栏目</a></td>
	</tr>
	  <tr>
	    <td class='forumRowHighLight' height=23>导航链接</td>
	    <td class='forumRowHighLight'><input name='url' type='text' id='url' size='40'></td>
      </tr>
	  <tr>
