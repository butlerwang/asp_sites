...
WebNewNewsList=WebNewNewsList&"<tr><td width='75%'>· <a href='"&rs_url&"' target='_blank' title='"&rsp("title")&"'>"&left(rsp("title"),24)&"</a></td>"
...
Block03_LeftItem=Block03_LeftItem&"<p class='ProTitle'><strong><A  href='"&rs_url&"' target='_blank' >"&left(rsp("title"),12)&"</A></strong> </p>"
Block03_LeftItem=Block03_LeftItem&"<p class='ProTxt'>"&left(ClearHtml(rsp("content")),40)&"...</p>"
Block03_LeftItem=Block03_LeftItem&"<p class='ProMore'><a  href='"&rs_url&"' target='_blank' >>>详细信息</a></p>"
