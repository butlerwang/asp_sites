...
PicsCount=0
End if
list_block=list_block&"<div class='ImageBlockBG'><div class='ImageBlock'><a href='"&rs_url&"'  title='"&rs("title")&"' target='_blank'><img src='/images/up_images/"&rs("image")&"' alt='"&rs("title")&"'/></a><p><a href='"&rs_url&"'  title='"&rs("title")&"' target='_blank'>"&Left(rs("title"),10)&" ["&PicsCount&"]</a></p></div></div> "
